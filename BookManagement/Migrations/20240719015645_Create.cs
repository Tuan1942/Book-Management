    ...
    public partial class Create : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModifyHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModifyHistories_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ModifyHistories_Users_ModifiedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModifyHistories_BookId",
                table: "ModifyHistories",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_ModifyHistories_ModifiedBy",
                table: "ModifyHistories",
                column: "ModifiedBy");
